        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-slate-800 hover:bg-primary/40 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  <a href="tel:+12064553644" className="text-slate-200 hover:text-primary transition-colors duration-300 font-semibold">
                    (206) 455-3644
                  </a>
                </li>
                <li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/privacy-policy" className="text-slate-400 hover:text-primary transition-colors duration-300">
                Privacy Policy
              </Link>
              <Link href="/terms-of-service" className="text-slate-400 hover:text-primary transition-colors duration-300">
                Terms of Service
              </Link>
