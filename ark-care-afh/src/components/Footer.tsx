          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <div className="flex gap-3" role="list" aria-label="Social media links">
                <a 
                  href="#" 
                  className="w-10 h-10 bg-slate-800 hover:bg-primary/40 rounded-lg flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-slate-900"
                  aria-label="Visit our Facebook page"
                  role="listitem"
                >
                  <svg className="w-5 h-5 text-slate-300 hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
