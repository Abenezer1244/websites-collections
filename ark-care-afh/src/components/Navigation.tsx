...
export function Navigation() {
  ...
  return (
    <>
      {/* Fixed Logo in Top-Left Corner - Closer to Navbar */}
      <div className="fixed top-7 left-4 sm:left-6 z-50 pointer-events-auto">
        <Link
          href="/"
      ...
      {/* Navbar and Schedule Button Container */}
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 md:pt-8 pointer-events-none px-4 sm:px-6">
        <div className="flex items-center gap-3 w-full max-w-5xl">
          ...
          <div className="pointer-events-auto flex-1 bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-2xl px-6 md:px-8 py-3 md:py-4 animate-float">
          ...
          {/* Schedule a Tour Button - Next to Navbar */}
          <a
            href="tel:+12064553644"
            className="pointer-events-auto hidden md:inline-flex items-center justify-center w-12 h-12 bg-white/20 hover:bg-white/30 text-white rounded-full transition-all duration-200 border border-white/30 flex-shrink-0"
