    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
        <div className="h-full px-4 sm:px-6 lg:px-8 pt-5 md:pt-6 flex items-center w-full">
          ...
          <div className="pointer-events-auto w-full max-w-7xl bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-2xl px-6 md:px-10 py-3 md:py-4 animate-float">
