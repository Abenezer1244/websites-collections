      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-slate-800">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">2. Services Overview</h2>
            <p>
            ...
            <p className="font-semibold text-slate-900 mt-6">Resident Responsibilities:</p>
            <ul className="space-y-3 ml-6 list-disc">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">5. Payment & Fees</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">6. Discharge Policy</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">7. Health & Safety</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">8. Medical Care Coordination</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">10. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">11. Complaint & Dispute Resolution</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">12. Intellectual Property</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">13. Third-Party Links</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">14. Governing Law</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">15. Contact & Questions</h2>
            <p>
