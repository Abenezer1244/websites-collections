      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-muted-foreground">
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">2. Health Information & HIPAA Compliance</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">3. Information We Collect</h2>
            <p className="font-semibold text-foreground">We may collect the following types of information:</p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">4. How We Use Your Information</h2>
            <p className="font-semibold text-foreground">We use the information we collect for:</p>
            <ul className="space-y-3 ml-6 list-disc">
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">5. Information Sharing & Disclosure</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">6. Data Security</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">7. Cookies & Website Tracking</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">8. Your Rights</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">10. Policy Changes</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-8 mb-4">11. Effective Date</h2>
            <p>
