  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden text-white min-h-screen flex items-center">
        ...
        <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-primary/40 to-primary/20 rounded-full blur-3xl animate-orb-1 pointer-events-none z-10" />
        <div className="absolute bottom-32 left-10 w-80 h-80 bg-gradient-to-br from-cyan-400/35 to-cyan-500/15 rounded-full blur-3xl animate-orb-2 pointer-events-none z-10" />
        <div className="absolute top-1/2 right-1/3 w-72 h-72 bg-gradient-to-br from-blue-400/30 to-blue-400/10 rounded-full blur-3xl animate-orb-3 pointer-events-none z-10" />
