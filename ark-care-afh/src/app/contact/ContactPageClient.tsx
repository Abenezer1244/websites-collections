      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50 mb-8">Get in Touch</h2>

              <div className="mb-8">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-50 mb-2">Phone</h3>
                <p className="text-slate-800 dark:text-slate-200">Coming soon</p>
              </div>
              ...
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-50 mb-2">Address</h3>
                <p className="text-slate-800 dark:text-slate-200">Coming soon</p>
              </div>

              <div className="mb-8">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-50 mb-2">Hours</h3>
                <p className="text-slate-800 dark:text-slate-200">Available 24/7 for emergencies</p>
                <p className="text-slate-800 dark:text-slate-200">Office hours: Coming soon</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-8">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50 mb-6">Send us a Message</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-background text-slate-900 dark:text-slate-50"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-background text-slate-900 dark:text-slate-50 resize-none"
                ...
                <p className="text-sm text-slate-800 dark:text-slate-200 mt-4">
                  * Required fields
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <details className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-6">
              <summary className="cursor-pointer font-semibold text-slate-900 dark:text-slate-50 flex justify-between items-center">
