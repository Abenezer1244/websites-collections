...
**Subject:**
```
New Contact Form Inquiry from Rejoice AFH Website
```

**Content:**
```
New inquiry received from Rejoice AFH website contact form.
...
---
This email was sent from the Rejoice AFH contact form.
```
...
4. **Optional** - Update the recipient email address (line ~505):
   ```javascript
   to_email: 'your-email@rejoiceafh.com'
   ```
